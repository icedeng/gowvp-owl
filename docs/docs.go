...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/channels/{id}/snapshot/{session_id}/status": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/channels/{id}/upgrade/{session_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "api.SwaggerGBDeviceConfigInput": {
            ...
            "properties": {
                ...
                "snapshot_config": {
                    "$ref": "#/definitions/api.SwaggerGBSnapshotConfigInput"
                },
                "svac_decode_config": {
                    "$ref": "#/definitions/api.SwaggerGBXMLConfigInput"
                },
        ...
        "api.SwaggerGBDeviceControlInput": {
            ...
            "properties": {
                ...
                "target_track": {
                    "description": "2022 目标跟踪参数",
                    "allOf": [
                        {
                            "$ref": "#/definitions/api.SwaggerGBTargetTrackInput"
                        }
                    ]
                },
                "timeout": {
        ...
        "api.SwaggerGBSnapshotConfigInput": {
            "type": "object",
            "properties": {
                "interval": {
                    "type": "integer",
                ...
                "session_id": {
                    "type": "string",
                    "example": "snapshot-session-0000000000000001"
                },
                "snap_num": {
                    "type": "integer",
                    "example": 1
                ...
                "upload_url": {
                    "type": "string",
                    "example": "https://example.com/gb28181/snapshot"
                }
            }
        },
        "api.SwaggerGBTargetTrackInput": {
            "type": "object",
            "properties": {
                "device_id2": {
                    "type": "string",
        ...
        "api.SwaggerSIPConfig": {
            ...
            "properties": {
                ...
                "signal_digest": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/api.SwaggerSIPSignalDigest"
                        }
                    ]
                },
                "strict_source_check": {
        ...
        "api.SwaggerSIPMonitorUserIdentity": {
            "type": "object",
            "properties": {
                "allowed_categories": {
                    "type": "array",
        ...
        "api.SwaggerSIPSignalDigest": {
            ...
            "properties": {
                ...
                "required": {
                    "description": "强制模式；同时启用出站签名并拒绝缺失或验签失败的入站报文",
                    "type": "boolean",
                    "example": false
                },
                "seed": {
        ...
        "api.SwaggerSIPUpstream": {
            ...
            "properties": {
                ...
                "monitor_user_identity": {
                    "$ref": "#/definitions/api.SwaggerSIPMonitorUserIdentity"
                },
                "name": {
                    "type": "string",
                    "example": "provincial"
                ...
                "tls_ca": {
                    "type": "string",
                    "example": "configs/certs/upstream-ca.crt"
                },
                "tls_cert": {
                    "type": "string",
                    "example": "configs/certs/cascade-client.crt"
                },
                "tls_key": {
                    "type": "string",
                    "example": "configs/certs/cascade-client.key"
                },
                "tls_server_name": {
                    "type": "string",
        ...
        "api.queryRecordsInput": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "录像类型：time、alarm、manual、all；空值默认 time",
                    "type": "string",
                    "example": "all"
                }
            }
        ...
        "api.upgradeDeviceInput": {
            ...
            "properties": {
                ...
                "session_id": {
                    "description": "升级流程会话 ID；空值由平台生成，长度 32~128",
                    "type": "string",
                    "example": "upgrade-session-0000000000000001"
                },
                "timeout": {
                    "description": "等待设备应答超时时间，单位秒",
                    "type": "integer",
