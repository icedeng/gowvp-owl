...
async function load() {
  ...
  loadError.value = ''
  try {
    const [mediaResponse, channelResponse, statResponse] = await Promise.allSettled([api.mediaServers({ page: 1, size: 100 }), loadStreamCounts(), api.stats()])
